    ...
    def detect_signals(self, df: pd.DataFrame, emaper_force, 
        ...
        for i in range(1, len(df)):
            ...
            if close > ema_long:
                ...
                if in_up_first_signal and (emaper - previous_emaper) > 0 and emaper < -emaper_force:
                    signal_up[i] = 1
            ...
            if close < ema_long:
                ...
                if in_down_first_signal and (emaper - previous_emaper) < 0 and emaper > emaper_force:
                    signal_down[i] = -1
